...
const (
	...
	FULL_DEPTH_MOVES int = 4       // specifies number of moves evaluated at full depth before LMR
	REDUCTION_LIMIT  int = 3       // defines the minimum remaining search depth required to trigger LMR

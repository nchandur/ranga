...
const (
	...
	ISMATE           int = 49000   // base score used to identify mate condition
	MATESCORE        int = 48000   // threshold above which scores represent guaranteed checkmate sequences within x plies
	INFINITY             = 50000   // upper numeric boundary
	...
	BIG_DELTA        int = 200     // delta pruning
)
